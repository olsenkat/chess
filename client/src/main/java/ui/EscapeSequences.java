...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_DARK_PURPLE = SET_BG_COLOR + "53m";
    public static final String SET_BG_COLOR_PURPLE = SET_BG_COLOR + "91m";
    public static final String SET_BG_COLOR_LIGHT_PURPLE = SET_BG_COLOR + "219m";
